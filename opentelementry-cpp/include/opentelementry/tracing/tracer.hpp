...
#define OPENTELEMENTRY_SPAN(tracer, name) \
    ::opentelementry::tracing::ScopedSpan _opentelementry_span_##__LINE__(tracer, name)

#define OPENTELEMENTRY_SPAN_OK(tracer, name) \
    ::opentelementry::tracing::ScopedSpan _opentelementry_span_##__LINE__(tracer, name); \
    _opentelementry_span_##__LINE__.set_ok()
