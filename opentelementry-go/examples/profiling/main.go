...
func runInferenceSimulation(ctx context.Context, p *opentelementry.Opentelementry, config LLMConfig, duration time.Duration) {
...
func inferenceWorker(ctx context.Context, p *opentelementry.Opentelementry, config LLMConfig, workerID int, requestChan <-chan InferenceRequest, stopChan <-chan struct{}) {
	for {
		select {
		case <-stopChan:
			return
...
func processInferenceRequest(ctx context.Context, p *opentelementry.Opentelementry, config LLMConfig, workerID int, req InferenceRequest) {
