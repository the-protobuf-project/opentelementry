...
// logLevelToCharm converts a opentelementry LogLevel to a charmbracelet log.Level.
...
// extractStructTagAttributes extracts attributes from struct fields with `opentelementry:"attribute:key_name"` tags
func extractStructTagAttributes(rv reflect.Value) []otellog.KeyValue {
	...
	for i := 0; i < rv.NumField(); i++ {
		...
		// Check for opentelementry struct tag
...
// It extracts struct tags with format `opentelementry:"attribute:key_name"` and adds them as attributes
