...
- Enable MCAP recording for logs using Opentelementry.new() builder
...
def main():
    # Uses opentelementry.toml config - enable foxglove.enabled=true and set foxglove.file_path
    with Opentelementry.new().build() as opentelementry:
        ...
        opentelementry.logger.critical(
    ...
    # Opentelementry automatically closes when exiting the 'with' block
