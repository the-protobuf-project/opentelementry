...
Typical usage example:
    ...
    @opentelementry.trace("process_data", auto_events=True)
...
_current_opentelementry: ContextVar[Optional[Any]] = ContextVar(
    "current_opentelementry", default=None
)
...
def trace(
    ...
    It automatically finds the Opentelementry instance from the execution context.
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            opentelementry_instance = _current_opentelementry.get()

            if (
                not opentelementry_instance
                or not opentelementry_instance.tracing.enabled
            ):
                return func(*args, **kwargs)

            tracing = opentelementry_instance.tracing
...
def set_current_opentelementry(opentelementry_instance):
    """Set the current Opentelementry instance for decorator context.
    ...
    """
    return _current_opentelementry.set(opentelementry_instance)


def reset_current_opentelementry(token):
    """Reset the current Opentelementry instance.

    Args:
        token: Token returned from set_current_opentelementry.
    """
    _current_opentelementry.reset(token)
...
class TracedOperation:
    ...
    Example:
        with TracedOperation(opentelementry.tracing, "process_pipeline") as op:
    ...
    def __init__(
        ...
        Args:
            tracing: OpentelementryTracing instance.
