...
This module provides the main OpentelementryTracing class that integrates decorator-based
...
Typical usage example:
    ...
    @opentelementry.tracing.trace(name="operation")
    def my_function():
        pass

    # Manual span management
    with opentelementry.tracing.start_span("operation") as span:
...
class OpentelementryTracing:
    ...
    def trace(
        ...
        Example:
            @opentelementry.tracing.trace(name="process_data", attributes={"user_id": "123"})
    ...
    def start_span(
        ...
        Example:
            with opentelementry.tracing.start_span("operation", {"key": "value"}) as span:
                # Do work
                span.add_event("checkpoint")
