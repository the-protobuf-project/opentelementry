...
//!
//! ```no_run
//! use opentelementry::logging::{GlobalLogger, init, get};
...
impl GlobalLogger {
    ...
    ///
    /// ```no_run
    /// use opentelementry::logging::GlobalLogger;
    ///
    /// let logger = GlobalLogger::new(
    ///     "my-service".to_string(),
    ///     "1.0.0".to_string(),
    ...
    pub fn log_with_location(
        ...
        let relative_path = if let Some(idx) = file.rfind("/opentelementry-rs/") {
            &file[idx + 10..]
...
///
/// ```no_run
/// use opentelementry::logging::{GlobalLogger, init};
///
/// let logger = GlobalLogger::new(
///     "my-service".to_string(),
///     "1.0.0".to_string(),
...
///
/// ```no_run
/// use opentelementry::logging::get;
///
