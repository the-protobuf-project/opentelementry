...
//!
//! ```no_run
//! use opentelementry::{opentelementry_info, Logger};
//!
...
//! );
//!
//! opentelementry_info!(logger, "Application started");
//! ```
...
#[macro_export]
macro_rules! opentelementry_debug {
...
#[macro_export]
macro_rules! opentelementry_info {
    ($logger:expr, $msg:expr) => {
...
#[macro_export]
macro_rules! opentelementry_warn {
    ($logger:expr, $msg:expr) => {
...
#[macro_export]
macro_rules! opentelementry_error {
    ($logger:expr, $msg:expr) => {
