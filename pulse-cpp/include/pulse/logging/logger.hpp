...
#define PULSE_LOG_TRACE(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->trace(msg, __FILE__, __LINE__)
#define PULSE_LOG_DEBUG(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->debug(msg, __FILE__, __LINE__)
#define PULSE_LOG_INFO(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->info(msg, __FILE__, __LINE__)
#define PULSE_LOG_WARN(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->warn(msg, __FILE__, __LINE__)
#define PULSE_LOG_ERROR(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->error(msg, __FILE__, __LINE__)
#define PULSE_LOG_FATAL(msg) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->fatal(msg, __FILE__, __LINE__)

#define PULSE_LOG_TRACE_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->trace(msg, data, __FILE__, __LINE__)
#define PULSE_LOG_DEBUG_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->debug(msg, data, __FILE__, __LINE__)
#define PULSE_LOG_INFO_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->info(msg, data, __FILE__, __LINE__)
#define PULSE_LOG_WARN_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->warn(msg, data, __FILE__, __LINE__)
#define PULSE_LOG_ERROR_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->error(msg, data, __FILE__, __LINE__)
#define PULSE_LOG_FATAL_DATA(msg, data) \
    if (auto* l = ::pulse::logging::GlobalLogger::get()) l->fatal(msg, data, __FILE__, __LINE__)
