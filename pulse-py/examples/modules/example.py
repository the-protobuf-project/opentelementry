...
def main():
    ...
    # ========================================
    core = Pulse.new().with_service("robot-core", "1.0.0").build()
    ...
    motor = Pulse.new().with_service("motor-module", "1.5.0").build()
    ...
    print("  env var (PULSE_LOGGING_MODULES_<NAME>_LEVEL)")
