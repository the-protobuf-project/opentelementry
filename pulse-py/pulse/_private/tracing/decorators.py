    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            if args and hasattr(args[0], 'tracing'):
                tracing = args[0].tracing
            
            # Add event if tracing is available
            # Note: This assumes we're already in a span context
            # The actual event will be added by the caller
...
class TracedOperation:
    ...
    def __init__(self, tracing: "PulseTracing", name: str, attributes: Optional[Dict[str, Any]] = None):
