...
const METRIC_SCHEMA: &str = include_str!("schemas/machanirobotics.metric.json");
const TRACE_SCHEMA: &str = include_str!("schemas/machanirobotics.trace.json");
...
impl SchemaRegistry {
    ...
    ///
    /// ```no_run
    /// use pulse::foxglove::SchemaRegistry;
    ///
    ...
    fn register_builtin_schemas(&mut self) {
        ...
        self.schemas.insert(
            "machanirobotics.trace".to_string(),
