//! Custom log formatter for Pulse with colored output and service information.
//!
...
impl std::fmt::Debug for PulseFormatter {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("PulseFormatter").finish()
    }
}
...
impl PulseFormatter {
    ...
    ///
    /// ```no_run
    /// use pulse::logging::PulseFormatter;
    ///
    /// let formatter = PulseFormatter::new();
    /// ```
    pub fn new() -> Self {
        Self {
...
impl Encode for PulseFormatter {
...
///
/// ```no_run
/// use pulse::logging::formatter::format_data_output;
/// use serde_json::json;
///
