//! Traits for Pulse functionality.
//!
//! This module defines traits that types can implement to integrate with Pulse.
...
///
/// ```no_run
/// use pulse::traits::RecordMetrics;
/// use pulse::metrics::{MetricField, MetricType};
///
/// struct MyMetrics {
///     counter: u64,
/// }
